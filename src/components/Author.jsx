        ...
        <div className="bg-slate-50 pt-px sm:rounded-6xl">
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            ...
            <p className="mt-8 font-display text-5xl font-extrabold tracking-tight text-slate-900 sm:text-6xl">
              <span className="block text-blue-600">Vivek Poddar –</span> Hey
              there, I’m the author behind ‘Relearn’.
            </p>
            <p className="mt-4 text-lg tracking-tight text-slate-700">
              I'm excited to be the author of this system design and web
              development course. With over a decade of experience as a software
              engineer, I've had the opportunity to work for some of the biggest
              names in tech, including Amazon and Google. I've also collaborated
              with numerous startups, helping them bring their ideas to life.
              Throughout my career, I've developed a passion for sharing my
              knowledge with others, which is why I'm thrilled to be here today.
              I believe that anyone can learn to build amazing software with the
              right guidance and support, and I can't wait to be a part of your
              learning journey. Let's dive in!
            </p>
            <p className="mt-8">
              <Link
